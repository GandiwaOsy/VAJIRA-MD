...
global.owner = process.env.OWNER_NUMBER  || '94701992015' ;  // ADD YOUR NUMBER WITHOUT +263786619852
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=CJsSwSKY#xDdaqKnsNIFKWdfryxDsXbBhpi4eBK7BZSHqdhzEbFg' ,
travaSend: process.env.TRAVA_SEND || '25' ,   
MODERATORS : process.env.MODERATORS === undefined ? "94772801923,94787820101" : process.env.MODERATORS ,    
MAX_SIZE: process.env.MAX_SIZE === undefined ? '1536': process.env.MAX_SIZE,/*add this in megabytes*/    
OWNER_NAME: process.env.OWNER_NAME || 'OSIAS' ,
